...
def kloppai_simple_input(guessed_input):
    ...
    joystickPosition = vj.generateJoystickPosition(wAxisX = int(joystick_range * xPos),
                                                   wAxisZ = int(joystick_range * zPos))
    vj.update(joystickPosition)
    vj.close()
...
def nfsmw_speed_direction_input(guessed_input, full_speed=False):
    # Joystick goes from 0 to 32'000
    joystick_range = 32786
    joystick_amp = joystick_range/2 * 1
